...
def index(request):
    try:
        ...
        return HttpResponse(post["created"], content_type='text/plain')
    except:
        return HttpResponse("To use this API call, please supply param p=account/post, substituting account/post with the account and permlink of the post.\n\n"
                            'Example: https://api.steem.place/getPostDate/?p=moisesmcardona/preparing-dinner-2-chicken-thights\n\n'
                            'Returns: Post Date', content_type='text/plain')